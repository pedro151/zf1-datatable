 ...
 * @version    $Id$
 */
class ZfComplement_DataTable implements Iterator , Countable
{
    /**#@+
    ...
    public function __construct ( $options = null )
    {
        ...
        $this->getView ()->addHelperPath ( 'ZfComplement/View/Helper' , 'ZfComplement_View_Helper' );
    ...
    {
        /** @var ZfComplement_DataTable_Element $element */
    ...
    public function setPluginLoader ( Zend_Loader_PluginLoader_Interface $loader , $type = null )
    {
        ...
        switch ( $type )
        {
            ...
            default:
                ...
                throw new ZfComplement_DataTable_Exception(
     ...
     * ZfComplement_DataTable_Element. If a string element type is provided, $name must be
     * provided, and $options may be optionally provided for configuring the
     * element.
     *
     * If a ZfComplement_DataTable_Element is provided, $name may be optionally provided,
     * and any provided $options will be ignored.
     *
     * @param  string|ZfComplement_DataTable_Element $element
     * @param  string                        $name
     * @param  array|Zend_Config             $options
     *
     * @throws ZfComplement_DataTable_Exception on invalid element
     * @return ZfComplement_DataTable
     */
    public function addElement ( $element , $name = null , $options = null )
    {
        ...
        } elseif ( $element instanceof ZfComplement_DataTable_Element )
        {
            $prefixPaths = array ();
        ...
        } else
        {
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception(
                'Element must be specified by string or ZfComplement_DataTable_Element instance'
            );
        }
    ...
    public function createElement ( $type , $name , $options = null )
    {
        ...
        {
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception( 'Element type must be a string indicating type' );
        }

        if ( ! is_string ( $name ) )
        {
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception( 'Element name must be a string' );
        }
    ...
    public function addElements ( array $elements )
    {
        foreach ( $elements as $key => $spec )
        {
            ...
            if ( is_string ( $spec ) || ( $spec instanceof ZfComplement_DataTable_Element ) )
            {
     ...
     * @param  string $name
     *
     * @return ZfComplement_DataTable_Element|null
     */
    ...
    public function removeElement ( $name )
    {
        ...
        if ( isset( $this->_elements[ $name ] ) )
        {
            ...
            {
                /** @var ZfComplement_DataTable_DisplayGroup $group */
    ...
    public function getElementsAndSubFormsOrdered ()
    {
        ...
        foreach ( $this->_order as $name => $order )
        {
            ...
            if ( $this->$name instanceof ZfComplement_DataTable_Element
                 || $this->$name instanceof ZfComplement_DateTable
            )
            {
     ...
     *
     * @param  string|ZfComplement_DataTable_Decorator_Abstract $decorator
    ...
    {
        if ( $decorator instanceof ZfComplement_DataTable_Decorator_Abstract )
        {
        ...
        } elseif ( is_array ( $decorator ) )
        {
            ...
            } elseif ( $spec instanceof ZfComplement_DataTable_Decorator_Abstract )
            {
                $decorator = $spec;
            }
        } else
        {
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception(
                'Invalid decorator provided to addDecorator; must be string or ZfComplement_DataTable_Decorator_Abstract'
            );
        }
    ...
    public function addDecorators ( array $decorators )
    {
        foreach ( $decorators as $decoratorName => $decoratorInfo )
        {
            if ( is_string ( $decoratorInfo )
                 || $decoratorInfo instanceof ZfComplement_DataTable_Decorator_Abstract
            )
            {
            ...
            {
                require_once 'ZfComplement/DataTable/Exception.php';
                throw new ZfComplement_DataTable_Exception( 'Invalid decorator passed to addDecorators()' );
            }
        }
     ...
     * @param  string $name
     *
     * @return false|ZfComplement_DataTable_Decorator_Abstract
     */
    ...
    public function render ( Zend_View_Interface $view = null )
    {
        ...
        $content = '';
        /** @var ZfComplement_DataTable_Decorator_Abstract $decorator */
     ...
     * @param  string $name
     *
     * @return ZfComplement_DataTable_Element|ZfComplement_DataTable|null
     */
     ...
     *
     * @param  string                 $name
     * @param  ZfComplement_DataTable_Element $value
     *
     * @return void
     * @throws ZfComplement_DataTable_Exception for invalid $value
     */
    public function __set ( $name , $value )
    {
        if ( $value instanceof ZfComplement_DataTable_Element )
        {
    ...
    public function __call ( $method , $args )
    {
        if ( 'render' == substr ( $method , 0 , 6 ) )
        {
            ...
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception( sprintf ( 'Decorator by name %s does not exist' , $decoratorName ) );
        }

        require_once 'ZfComplement/DataTable/Exception.php';
        throw new ZfComplement_DataTable_Exception( sprintf ( 'Method %s does not exist' , $method ) );
    }
     ...
     *
     * @throws ZfComplement_DataTable_Exception
     * @return ZfComplement_DataTable_Element|ZfComplement_DataTable_DisplayGroup|ZfComplement_DataTable
     */
