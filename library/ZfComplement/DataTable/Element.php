...
class ZfComplement_DataTable_Element
{
    ...
    public function __construct ( $spec , $options = null )
    {
        ...
        if ( null === $this->getName () )
        {
            ...
            throw new ZfComplement_DataTable_Exception( 'Zend_Form_Element requires each element to have a name' );
        }
    ...
    public function __call ( $method , $args )
    {
        if ( 'render' == substr ( $method , 0 , 6 ) )
        {
            ...
            require_once 'ZfComplement/DataTable/Element/Exception.php';
            throw new ZfComplement_DataTable_Element_Exception( sprintf ( 'Decorator by name %s does not exist' , $decoratorName ) );
        }

        require_once 'ZfComplement/DataTable/Element/Exception.php';
        throw new ZfComplement_DataTable_Element_Exception( sprintf ( 'Method %s does not exist' , $method ) );
    }
    ...
    public function setPluginLoader ( Zend_Loader_PluginLoader_Interface $loader , $type )
    {
        ...
        switch ( $type )
        {
            ...
            default:
                require_once 'ZfComplement/DataTable/Exception.php';
                throw new ZfComplement_DataTable_Exception( sprintf ( 'Invalid type "%s" provided to setPluginLoader()' , $type ) );
        }
    }
    ...
    public function addPrefixPath ( $prefix , $path , $type = null )
    {
        ...
        switch ( $type )
        {
            ...
            default:
                require_once 'ZfComplement/DataTable/Exception.php';
                throw new ZfComplement_DataTable_Exception( sprintf ( 'Invalid type "%s" provided to getPluginLoader()' , $type ) );
        }
    }
    ...
    public function addFilters ( array $filters )
    {
        foreach ( $filters as $filterInfo )
        {
            ...
            {
                require_once 'ZfComplement/DataTable/Exception.php';
                throw new ZfComplement_DataTable_Exception( 'Invalid filter passed to addFilters()' );
            }
        }
    ...
    protected function _loadFilter ( array $filter )
    {
        ...
        {
            require_once 'ZfComplement/DataTable/Exception.php';
            throw new ZfComplement_DataTable_Exception( sprintf ( 'Filter instance already exists for filter "%s"' , $origName ) );
        }
