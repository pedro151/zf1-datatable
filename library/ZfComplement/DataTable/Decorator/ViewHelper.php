...
class ZfComplement_DataTable_Decorator_ViewHelper extends ZfComplement_DataTable_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $helper
     * @return ZfComplement_DataTable_Decorator_Element_ViewHelper
     */
     ...
     * Get name
     *
     * If element is a ZfComplement_DataTable_Element, will attempt to namespace it if the
     ...
     *
     * @param  ZfComplement_DataTable_Element $element
     * @return string|null
     */
     ...
     * @return string
     * @throws ZfComplement_DataTable_Decorator_Exception if element or view are not registered
     */
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new ZfComplement_DataTable_Decorator_Exception('ViewHelper decorator cannot render without a registered view object');
        }
